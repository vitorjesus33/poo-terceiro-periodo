...
public class CalculadoraPreco {
    private static Historico historico = new Historico("historico.csv");
    ...
    public static void calcularPreco() {
        ...
        // Criar um novo registro com a data e hora atuais e adicioná-lo ao histórico
        LocalDateTime dataAtual = LocalDateTime.now();
        Registro registro = new Registro(quantidade, total, desconto, dataAtual);
